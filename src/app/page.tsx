    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
          Tap into any API.
          <br />
          <span className="text-emerald-400">Pay per use.</span>
        </h1>
        <p className="text-lg text-zinc-400 max-w-2xl mx-auto mb-8">
          An AI API marketplace powered by x402 micropayments. No API keys, no subscriptions — just pay per request with USDC on Base.
        </p>
      ...
      <section className="border-t border-zinc-800 py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { step: "1", title: "Request", desc: "You call an API endpoint" },
              { step: "2", title: "402 Challenge", desc: "Server returns payment requirements" },
              { step: "3", title: "Sign & Pay", desc: "Your wallet signs a USDC micropayment" },
              { step: "4", title: "Receipt", desc: "Server verifies, settles on-chain, returns result" },
            ].map((s) => (
